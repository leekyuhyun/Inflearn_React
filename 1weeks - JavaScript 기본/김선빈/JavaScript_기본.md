...
- *HTML*은 요소들의 내용, 배치, 모양을 정하기 위해 사용하는 언어
- *CSS*는 요소들의 색상, 크기 등의 스타일을 설정하는 언어
- *JavaScripts*는 웹 내부에서 발생하는 다양한 기능을 만들 수 있는 언어
...
<img src="https://jinyisland.kr/assets/js/datatypes.png" width="400px">
...
<img src="https://velog.velcdn.com/images/rla0591/post/7d846c5c-6604-4716-a05a-3b376f770f53/image.png" width="400">
...
let var2 = 10;
let var3 = 20;
console.log(var1 ?? var2); // 10 출력
console.log(var2 ?? var3); // 앞에 있는 var2인 10 출력
```
### typeof 연산자
